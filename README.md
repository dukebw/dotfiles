...
Zellij tab with `gh pr-review` and Neovim Diffview focused on the full PR diff,
including patch files, Dockerfiles, tests, and deployment configuration. Other
repositories use `~/work/<repo>-pr<number>/`.
